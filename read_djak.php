...
<head>
	...
	<title>Svi moji polaznici </title>
</head>
								...
								while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
									...
									<tr style="font-size: 12px; " >
										...
										<td class="text-center" style="width: 20%">
												...
												&nbsp;&nbsp;<a class="btn btn-outline-success btn-sm"  href="evidencija_djak.php?id=<?php echo $row['id']; ?>  "  target="_blank"><i class="bx bx-pencil"></i> dolaska</a>
