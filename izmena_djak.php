...
?>
    <form action='izmena_djak.php?id=<?php echo $id; ?>' method='post' >

        <table class='table table-responsive'>

            <tr>
                <td class='width-30-percent'>Ime:</td>
                <td><input type='text' name='firstname' value= "<?php echo $firstname; ?>" class='form-control' required /></td>
            </tr>
            ...
            <tr>
                <td>Broj telefona:</td>
                <td><input type='text' name='contact_number' class='form-control' required value="<?php echo $contact_number;  ?>" /></td>
            </tr>
            <tr>
            ...
            <td class='width-30-percent'>Datum rodjenja:</td>
                <td>
                    <input type="text"  name="datum_rodjenja" <?php if(isset($dat_rodjenja)){echo"value='$dat_rodjenja'";} ?>  STYLE="background-color:white; border: solid 0.01em gray; border-radius : 3px; padding: 6px;" size="10" class="tcal" />
               </td>
        </tr>
        <tr>
                ...
                <?php 
                     ...
                     <select class='form-control' name='fk_lokacija'>
        ...
        <tr>
			...
			<tr>
                <td>Komentar:</td>
                <td><textarea name='komentar' class='form-control' ><?php echo $komentar;  ?></textarea></td>
            </tr>
            <tr>
            <td>Komentar za posebne finsijske uslove:</td>
            <td><input type='text' name='komenatr_finansije' class='form-control' value="<?php echo $komenatr_finansije; ?>" / ></td>
            </tr>

            <tr style='display:none;'>
                <td>Vrsta obrazovanja:</td>
                <td><select  style="max-width: 250px;" class='form-control' name='online' required>
