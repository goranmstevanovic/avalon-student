...
<form>
    ...
    <!-- table headers -->
   <thead><tr><th >Jezik</th><th  >Nivo</th><th >Profesor</th><th >Alias</th><th>Broj djaka</th><th>Veličina</th><th>Online<br/>skola <th>odrasli<br/>deca</th><th>Udzbenici</th> </th><th>Akcija</th></tr></thead>
   <tfoot><tr><th >Jezik</th><th  >Nivo</th><th >Profesor</th><th >Alias</th><th>Broj djaka</th><th>Veličina</th><th>Online<br/>skola <th>odrasli<br/>deca</th><th>Udzbenici</th> </th><th>Akcija</th></tr></tfoot>
...
?>
        ...
        <?php 
          //  echo "VV: ",$velicina;
            if($velicina == null){$velicina = 1;}
          //  echo "VV: ",$velicina;
            $stm_velicina = $velicina1->read_one_velicina($velicina,'velicina');
            $row_velicina = $stm_velicina->fetch(PDO::FETCH_ASSOC);
            echo $row_velicina['ime'] ?? "";
        ...
        <td>
            <?php 
            if (file_exists("images/uzrast/".$uzrast."_thump.jpg")){
                $slika_link = "images/uzrast/".$uzrast."_thump.jpg";
              }
              if (file_exists("images/uzrast/".$uzrast."_thump.png")){
                $slika_link = "images/uzrast/".$uzrast."_thump.png";
              }
              if (file_exists("images/uzrast/".$uzrast."_thump.tif")){
                $slika_link = "images/uzrast/".$uzrast."_thump.tif";
              }  
            ...
            ?>  
                ...
                <img src="<?=$slika_link ?>"  style="width: auto;  height: 28px; padding-left: 5px; padding-right: 15px;padding-top: 4px; ">
                <p style="display:none"><?=$uzrast ?></p>
        ...
        <td align="center" >
        <a class="btn btn-success btn-sm"  href = "fullcalendar4/kalendar_grupa?grupa=<?php echo $row['id']; ?> " >
            <span class="glyphicon glyphicon-calendar"></span> &nbsp;Raspored</a>
            <a class="btn btn-primary btn-sm"  href = "update_grupa.php?id=<?php echo $row['id']; ?> " >
