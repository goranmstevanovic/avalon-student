...
class profaktura_zaduzenje
{
    private $conn;
    private $table_name = "profakture_zaduzenja";

    public $id;
    public $fk_profaktura;
    public $iznos;
    public $popust;
    public $ukupno;
    public $fk_djak;
   ...
   public function __construct($db)
    ...
    function create()
    {
           ...
           // insert query
            ...
            // bind the values
            $stmt->bindParam(':fk_profaktura', $this->fk_profaktura);
    ...
    function read_all_profaktura($fk_profaktura )
    {

        // query to select all user records
        $query = "SELECT pz.* , dj.firstname AS djak_ime, 
        dj.lastname AS djak_prezime, nz.ime AS ime_nacina_zaduzivanja, dj.id AS id_djaka
        ...
        WHERE pz.fk_profaktura = $fk_profaktura
          ";
    ...
    function soft_delete($id_zaduzenja, $obrisao){
       ...
       // $this->deleted=htmlspecialchars(strip_tags($this->deleted));
        ...
        $stmt->bindParam(':id_zaduzenja', $id_zaduzenja);
    ...
    function read_all_prijem_novca_profesor_month($prof,$mesec)
    {
        ...
        $query = "SELECT
                ...
                FROM
                    " . $this->table_name . "
               WHERE `fk_profaktura` LIKE '%$mesec%' && `platilac` = '$prof' ORDER by id
				";
