   ...
   public function __construct($db)
    ...
    function create()
    {
           ...
           // insert query
            ...
            $stmt->bindParam(':datum_valute', $this->datum_valute);
    ...
    function read_all_inactive()
    {

        // query to select all user records
        $query = "SELECT p.* , mpl.ime AS ime_mog_pravnog_lica, mpl.id AS id_pravnog_lica
        FROM " . $this->table_name . " p
        INNER JOIN moja_pravna_lica mpl ON mpl.id =  p.fk_moje_pravno_lice 
    ...
    function update($idfakture)
    {
           ...
           // $stmt->bindParam(':fk_moje_pravno_lice', $this->fk_moje_pravno_lice);
            ...
            $stmt->bindParam(':kreirao', $this->kreirao);
            $stmt->bindParam(':active', $this->active);
            $stmt->bindParam(':idfakture', $idfakture);
