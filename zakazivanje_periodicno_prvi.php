...
//echo " Pisemo Od: ",$sati_od,":",$minuti_od," /DO: ",$sati_do,":",$minuti_do,"<br/>";
                            ...
                            if($postojanje_rasporeda == 1 || $postojanje_rasporeda == 2){
                                ...
                                if($broj_termina_grupe_na_dan == 0){
                                    if($termin->create_termin()){
                                        ...
                                        // echo "Uspešno ste zakazali termin proverite u kalendaru 12";
                                        // echo "</div>";
                                        $_POST=array();
                                    }else{
                                ...
                                if($broj_termina_grupe_na_dan > 0){
                                    ...
                                    //     var_dump($stmt_brisi_termine_grupa_dan);
                                        if($termin->create_termin()){
                                            // echo "<div class='alert alert-info'>";
                                            // echo "Uspešno ste zakazali termin proverite u kalendaru 1";
                                            // echo "</div>";
                                            $_POST=array();
                                        }else{
                                            echo "<div class='alert alert-danger' role='alert'>";
                            ...
                            if($postojanje_rasporeda == 3 ){
                                if($termin->create_termin()){
                                    // echo "<div class='alert alert-info'>";
                                    // echo "Uspešno ste zakazali termin proverite u kalendaru 3";
                                    // echo "</div>";
                                    $_POST=array();
                                }else{
                                    echo "<div class='alert alert-danger' role='alert'>";
